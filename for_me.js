...
function createNameSprite(name, lives = null) {
    ...
    context.fillStyle = '#000000'; // Black color for name
    ...
    if (lives !== null) {
        ...
        context.fillStyle = '#ff0000'; // Keep hearts red
...
function endGame(message, isWin = false) {
    ...
    gameOverDiv.style.color = isWin ? '#006400' : '#8B0000'; // Green for win, Dark red for lose
...
// Update initializeGame function to include timer
function initializeGame() {
    ...
    window.timerInterval = setInterval(() => {
        ...
        if (timeLeft <= 0) {
            ...
            // End game with appropriate message
    ...
    // Create hearts board (keep existing hearts board code)
